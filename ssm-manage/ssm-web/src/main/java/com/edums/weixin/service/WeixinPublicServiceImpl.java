package com.edums.weixin.service;
           ...
           /* case 2: // 取消关注
            ...
            case 3: // 图文、文本、音频回复(完全匹配比模糊匹配优先级高)
                if("123".equals(content)){
                    String context = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb45f51d84bc958bd&redirect_uri=http://63191025.ngrok.io/edums-web/wxapi/authIndex.action&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect";
